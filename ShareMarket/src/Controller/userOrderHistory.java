...
public class userOrderHistory extends MySQLConnection  {
	...
	public static void getHistory(int id) {
		...
		try {
			...
			while(rs.next()) {
				f =1;
				System.out.println("Order ID : " + rs.getInt(1) + " Stock Symbol : " +  rs.getString(3) + " Investment-Type : " + rs.getString(4) + "Order Type : " + rs.getString(5) + " BUY?SELL : " + rs.getString(6) + " Quantity : " + rs.getInt(7) + " Order Date : "  + rs.getTimestamp(8)   );
			}
